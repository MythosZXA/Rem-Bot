...
function pageClosers() {
  ...
  // initialize
  useEffect( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _yield$Promise$all, _yield$Promise$all2, dataAgents, dataAreas;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return Promise.all([fetchData('closers_agents'), fetchData('closers_areas')]);
        case 2:
          _yield$Promise$all = _context.sent;
          _yield$Promise$all2 = _slicedToArray(_yield$Promise$all, 2);
          dataAgents = _yield$Promise$all2[0];
          dataAreas = _yield$Promise$all2[1];
          setAgents(dataAgents);
          setAreas(dataAreas.map(function (objArea) {
            return objArea.name;
          }));
        case 8:
        case "end":
  ...
  }), /*#__PURE__*/React.createElement("h2", null, selectedAgent.name), areas.length > 0 && /*#__PURE__*/React.createElement("div", {
    id: "divClosersCenter"
...
function AgentSelect(_ref2) {
  var agents = _ref2.agents,
    setSelectedAgent = _ref2.setSelectedAgent;
...
function Areas(_ref4) {
  var areas = _ref4.areas,
    selectedAgent = _ref4.selectedAgent;
  ...
  var _useState9 = useState({}),
    ...
    dailies = _useState10[0],
    setDailies = _useState10[1];

  // initialize
  useEffect( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var _yield$Promise$all3, _yield$Promise$all4, dataDailies, dataSectors, mapDailies;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return Promise.all([fetchData('closers_dailies'), fetchData('closers_sectors')]);
        case 2:
          _yield$Promise$all3 = _context2.sent;
          _yield$Promise$all4 = _slicedToArray(_yield$Promise$all3, 2);
          dataDailies = _yield$Promise$all4[0];
          dataSectors = _yield$Promise$all4[1];
          // turn dailies data into a map utilizing agent id and sector id as key
          mapDailies = {};
          dataDailies.forEach(function (daily) {
            var key = "".concat(daily.agent_id, "-").concat(daily.sector_id);
  ...
  var renderRow = function renderRow(rowSectors) {
    return rowSectors.map(function (sector) {
      return /*#__PURE__*/React.createElement("div", {
        ...
        onChange: function onChange(event) {
          return updateDailies(event, sector.id);
        }
      }), /*#__PURE__*/React.createElement("label", {
  ...
  var isComplete = function isComplete(sectorID) {
    var _dailies$key;
    var agentID = selectedAgent.id;
    var key = "".concat(agentID, "-").concat(sectorID);
    return ((_dailies$key = dailies[key]) === null || _dailies$key === void 0 ? void 0 : _dailies$key.cleared) === 1;
  };
  var updateDailies = function updateDailies(event, sectorID) {
    console.log(dailies);
    var agentID = selectedAgent.id;
    var key = "".concat(agentID, "-").concat(sectorID);
    setDailies(function (prevDailies) {
      return _objectSpread(_objectSpread({}, prevDailies), {}, _defineProperty({}, key, _objectSpread(_objectSpread({}, prevDailies[key]), {}, {
